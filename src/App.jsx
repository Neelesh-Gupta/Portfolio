...
const selectedWorks = [
  ...
  },
  {
    ...
    description:
      'Real-time analytics with dark-mode glass UI and buttery-smooth micro-interactions.',
    span: '',
  },
  {
    ...
    category: 'Marketing',
    description:
      'Conversion-focused layout with scroll-driven animations and mobile-first responsiveness.',
    span: '',
  },
  {
    title: 'Design System',
    category: 'UI Kit',
    description:
      'A scalable component library with glass tokens, typography scales, and motion guidelines.',
    span: 'md:col-span-2',
  },
  {
    title: 'Motion Study',
    ...
    description:
      'Experimental WebGL canvas exploring organic forms and aurora-inspired color palettes.',
    span: '',
  },
]
